...
// TestReconcileConfig_StartsLifecyclerOnMidRunSwap verifies the fix for a bug
// where switching the weather provider to Tempest via the settings UI while
// the service was already polling (e.g. still running yr.no) never started
