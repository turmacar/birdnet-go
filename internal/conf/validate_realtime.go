...
var validWeatherProviders = []string{"none", "yrno", "openweather", "wunderground", "tempest"} //nolint:goconst // weather-provider value, not the RetentionPolicyNone constant
